...
<div class="commercants-container">
        ...
        <div class="commercant-card">
            <div class="commercant-card-body">
                ...
                <div class="action-buttons">
                    ...
                    <a href="{{ route('consommateur.commercants.show', $commercant->id) }}" class="btn-view-products">
                        Voir les produits
                    </a>

                    {{-- Formulaire pour arrêter de suivre ce commerçant --}}
                    <form action="{{ route('consommateur.commercants.neplussuivre', $commercant->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
    ...
    <div class="no-commercants-alert">
        ...
        <a href="{{ route('consommateur.commercants.index') }}">Parcourir les commerçants</a>
    </div>
    @endif
</div>
