...
<div class="container py-5">
    ...
    <div class="search-container mb-5">
        <form action="{{ route('consommateur.commercants.index') }}" method="GET" class="search-form">
    ...
    <div class="merchants-grid">
        ...
        <div class="merchant-card">
            ...
            <a href="{{ route('consommateur.commercants.show', $commercant->id) }}" class="merchant-link">
