<!-- resources/views/admin/users/commercants.blade.php -->
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="h3 mb-0">Gestion des commerçants</h1>
            <p class="text-muted">Liste de tous les commerçants enregistrés sur la plateforme</p>
        </div>
        <div class="col-md-4 text-end">
            <a href="{{ route('admin.users.create') }}" class="btn btn-primary">
                <i class="fas fa-plus-circle me-2"></i>Ajouter un commerçant
            </a>
        </div>
    </div>
    ...
    <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('admin.users.commercants') }}">Commerçants</a>
        </li>
        <li class="nav-item">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form class="search-form" action="{{ route('admin.users.commercants') }}" method="GET">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Rechercher un commerçant..." name="search" value="{{ request('search') }}">
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger" title="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce commerçant?')">
