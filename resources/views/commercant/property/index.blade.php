...
@section('content')
    ...
    <div class="table-container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('commercant.property.index') }}" method="GET" class="product-filter-form">
            ...
            <a href="{{ route('commercant.property.create') }}" class="add-product-btn"> + Ajouter un produit</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="product-action-buttons">
                                    <a href="{{ route('commercant.property.edit', $propriete) }}" class="btn edit-product-btn">Éditer</a>

                                    <form action="{{ route('commercant.property.destroy', $propriete) }}" method="POST" class="product-delete-form">
                                        @csrf
                                        @method("DELETE")
